...
import alerter.*;
import statschecker.StatsChecker;
...
public class StatisticsTest {
	...
	public void reportsNaNForEmptyInput() {
		...
		assertTrue(Float.valueOf(s.getAverage()).isNaN());
		assertTrue(Float.valueOf(s.getMin()).isNaN());
		assertTrue(Float.valueOf(s.getMax()).isNaN());
